...
for filename in mapped_reads_files:
    ...
    mapped_reads_match = re.search(r'^(\d+)', lines[6])  # Fifth line contains mapped reads
...
output_file = os.path.join(directory_path, "Correction_1_Medaka_QualityReport.txt")
