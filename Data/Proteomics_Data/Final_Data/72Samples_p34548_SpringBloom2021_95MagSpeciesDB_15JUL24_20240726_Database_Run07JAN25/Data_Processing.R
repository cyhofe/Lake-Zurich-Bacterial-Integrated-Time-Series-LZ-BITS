...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Final_Data/72Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run07JAN25/")

#load data
Peptide_Table <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/72Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run07JAN25/proteinAbundances_.xlsx", sheet = 1)
Protein_Table_MedPolish <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/72Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run07JAN25/proteinAbundances_.xlsx", sheet = 3)
Protein_Table_IBAQ <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/72Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run07JAN25/proteinAbundances_.xlsx", sheet = 4)
...
Peptide_Table <- Peptide_Table %>%
  select(protein_Id, peptide_Id, IDcolumn, nrPeptides, c(10:81)) %>%
