...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Final_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/")

#load data
Peptide_Table <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/proteinAbundances_Mock_Prepared.xlsx", sheet = 1)
Protein_Table_MedPolish <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/proteinAbundances_Mock_Prepared.xlsx", sheet = 3)
Protein_Table_IBAQ <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/proteinAbundances_Mock_Prepared.xlsx", sheet = 4)
...
Peptide_Table <- Peptide_Table %>%
  select(protein_Id, peptide_Id, IDcolumn, nrPeptides, c(10:47)) %>%
...
Protein_Table_IBAQ <- Protein_Table_IBAQ %>%
  select(-description, -isotopeLabel, -fasta.id, -c(47:84)) %>%
  rename("Protein_Group" = "protein_Id",
