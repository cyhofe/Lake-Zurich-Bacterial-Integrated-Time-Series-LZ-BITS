...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Final_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25/")

#load data
Peptide_Table <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25/proteinAbundances_Mock_Prepared.xlsx", sheet = 1)
Protein_Table_MedPolish <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25/proteinAbundances_Mock_Prepared.xlsx", sheet = 3)
Protein_Table_IBAQ <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25/proteinAbundances_Mock_Prepared.xlsx", sheet = 4)
...
Peptide_Table <- Peptide_Table %>%
  select(protein_Id, peptide_Id, IDcolumn, nrPeptides, c(10:83)) %>%
...
Protein_Table_IBAQ <- Protein_Table_IBAQ %>%
  select(-description, -isotopeLabel, -fasta.id, -c(83:156)) %>%
  rename("Protein_Group" = "protein_Id",
