...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Final_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/")

#load data
Peptide_Table <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/proteinAbundances_Mock_Prepared.xlsx", sheet = 1)
Protein_Table_MedPolish <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/proteinAbundances_Mock_Prepared.xlsx", sheet = 3)
Protein_Table_IBAQ <- read_excel(path = "/SynologyDrive/PhD/Projects/SpringBloom2021/Data/Proteomics_Data/Raw_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/proteinAbundances_Mock_Prepared.xlsx", sheet = 4)
...
Peptide_Table <- Peptide_Table %>%
  select(protein_Id, peptide_Id, IDcolumn, nrPeptides, c(10:82)) %>%
...
write_csv(Peptide_Table_Combined, path = "Peptide_Table_Combined.csv")
