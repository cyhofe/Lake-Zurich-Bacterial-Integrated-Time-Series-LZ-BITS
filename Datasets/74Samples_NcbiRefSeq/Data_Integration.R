...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Datasets/74Samples_NcbiRefSeq/")

#load data
Species_Dat <- read.csv("../../Data/Species_Data/Final_Data/Species_Table.csv")
Peptide_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25//Peptide_Table_Combined_Filtered.csv")
Protein_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_NCBIrefseq_ContaminantsAndDatabase_Run19MAY25//Protein_Table_Combined_Filtered.csv")
