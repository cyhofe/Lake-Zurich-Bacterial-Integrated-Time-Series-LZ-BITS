...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Datasets/74Samples_Mock/")

#load data
Species_Dat <- read.csv("../../Data/Species_Data/Final_Data/Species_Table.csv")
Peptide_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/Peptide_Table_Combined_Filtered.csv")
Protein_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_MockCommunityDbSearch_MockD6300.Database_Run10SEP25/Protein_Table_Combined_Filtered.csv")
