...
setwd("/SynologyDrive/PhD/Projects/SpringBloom2021/Datasets/74Samples_CostumDB/")

#load data
Species_Dat <- read.csv("../../Data/Species_Data/Final_Data/Species_Table.csv")
Peptide_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/Peptide_Table_Combined_Filtered.csv")
Protein_Dat <- read.csv("../../Data/Proteomics_Data/Final_Data/74Samples_p34548_SpringBloom2021_95MagSpeciesDB_15JUL24_20240726_Database_Run18FEB25/Protein_Table_Combined_Filtered.csv")
